...
<html>
    ...
    <body class="light">
                ...
                <div class="container-fluid" style="background:linear-gradient(to bottom right, #F2F630, #FBF305);">
                    <div class="accordion py-4" id="accordionRecipe" style="padding:15%;">
                        ...
                        <div class='container-fluid bg-transparent'>
                            <div class="row">
                                <div class="col-md-7">
                                    <h1 class="text-dark mt-5 fw-bold fs-1">Welcome, to Musica</h1>
                                    ...
                                    <div class="row">
                                        <button class="btn btn-primary bg-transparent border-0 mx-2" style="width:20px;">
                                            <i class="fa-brands fa-instagram fa-xl text-dark"></i>
                                        </button>
                                        <button class="btn btn-primary bg-transparent border-0 mx-2" style="width:20px;">
                                            <i class="fa-brands fa-tiktok fa-xl text-dark"></i>
                                        </button>
                                        <button class="btn btn-primary bg-transparent border-0 mx-2" style="width:20px;">
                                            <i class="fa-brands fa-facebook text-dark fa-xl text-dark"></i>
                                        </button>
                                    </div>
                                </div>
                                <div class="col-md-5">
        ...
        <footer class="deneb_footer">
            <div class="widget_wrapper" style="background-image: url({{asset('assets/wave.png')}});">
                <div class="container">
                    <div class="row mt-5">
                            ...
                            <div class="widget widget_contact">
                                ...
                                <div class="contact_info">
                                    <div class="single_info">
                                        ...
                                        <div class="info">
                                            <p><a class="text-dark">0811 4882 001</a></p>
                                        </div>
                                    </div>
                                    <div class="single_info">
                                        <div class="icon">
                                        ...
                                        <div class="info">
                                            <p><a class="text-dark">flazen.edu@gmail.com</a></p>
                                        </div>
                                    </div>
                                    <div class="single_info">
                                        <div class="icon">
